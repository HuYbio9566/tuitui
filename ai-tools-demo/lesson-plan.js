...
function layout(content) {
  return `<div class="app-shell lesson-shell"><aside class="sidebar"><div class="brand"><span class="brand-mark">360</span><span>AI 云盘工具</span></div><div class="global-search"><i data-lucide="search"></i><span>搜索工具、文件或教案</span></div><div class="side-actions"><button class="side-action">上传</button><button class="side-action">新建</button></div><div class="side-label">工具导航</div><nav class="side-nav"><a class="side-link" href="index.html"><i data-lucide="layout-grid"></i>新增工具</a><a class="side-link active" href="lesson-plan.html"><i data-lucide="notebook-pen"></i>教案生成工具</a><a class="side-link" href="existing-tools.html"><i data-lucide="archive"></i>已有工具</a><a class="side-link" href="report.html"><i data-lucide="file-text"></i>调研报告</a></nav><div class="side-spacer"></div><div class="account"><span class="account-avatar">陈</span><span>陈老师 · 高中数学组</span></div></aside><main class="main"><header class="topbar"><div class="breadcrumb"><a href="index.html">AI 工具中心</a><span>/</span><strong>教案生成工具</strong></div><nav class="primary-nav"><a class="primary-nav-link" href="report.html">调研报告</a><a class="primary-nav-link active" href="index.html">新增工具</a><a class="primary-nav-link" href="existing-tools.html">已有工具</a></nav><div class="top-actions"><button class="btn" data-action="toast" data-toast="已打开教案记录">历史教案</button><button class="btn" data-action="toast" data-toast="教学设计帮助已打开">使用帮助</button></div></header>${content}</main></div>${state.modal ? renderModal() : ""}${state.toast ? `<div class="toast">${state.toast}</div>` : ""}`;
}
