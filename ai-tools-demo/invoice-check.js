    ...
    <div class="app-shell invoice-shell">
      <aside class="sidebar">
        ...
        <nav class="side-nav">
          ...
          <a class="side-link active" href="invoice-check.html"><i data-lucide="scan-line"></i>财务票据核验</a>
        ...
        <div class="account"><span class="account-avatar">财</span><span>财务审核员 · 王敏</span></div>
      </aside>
      <main class="main">
        <header class="topbar">
