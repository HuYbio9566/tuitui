  ...
  return `
    <div class="app-shell contract-shell">
      <aside class="sidebar">
        ...
        <nav class="side-nav"><a class="side-link" href="index.html"><i data-lucide="layout-grid"></i>新增工具</a><a class="side-link active" href="contract-review.html"><i data-lucide="scale"></i>合同风险审阅</a><a class="side-link" href="existing-tools.html"><i data-lucide="archive"></i>已有工具</a><a class="side-link" href="report.html"><i data-lucide="file-text"></i>调研报告</a></nav>
        <div class="side-spacer"></div><div class="account"><span class="account-avatar">法</span><span>法务协作 · 采购合同组</span></div>
      </aside>
