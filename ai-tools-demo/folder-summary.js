    ...
    <div class="app-shell folder-shell">
      <aside class="sidebar">
        ...
        <div class="side-actions">
          <button class="side-action" type="button">上传</button>
          <button class="side-action" type="button">新建</button>
        </div>
        <div class="side-label">工具导航</div>
        <nav class="side-nav">
          <a class="side-link" href="index.html"><i data-lucide="layout-grid"></i>新增工具</a>
          <a class="side-link active" href="folder-summary.html"><i data-lucide="folder-search"></i>文件夹智能摘要</a>
